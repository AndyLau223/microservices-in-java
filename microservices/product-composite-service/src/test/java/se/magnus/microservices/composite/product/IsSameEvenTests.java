...
public class IsSameEvenTests {
    ...
    void testEventObjectCompare() throws JsonProcessingException {
        ...
        String even1Json = mapper.writeValueAsString(event1);

        assertThat(even1Json, is(sameEventExceptCreatedAt(event2)));
        assertThat(even1Json, not(sameEventExceptCreatedAt(event3)));
        assertThat(even1Json, not(sameEventExceptCreatedAt(event4)));
    }
}
